...
The working directory needs to be changed in each piece of code to the directory which contains the folders /code, /data and /figures. This is located at the top of each piece of code.