...
### Create output lists for multinomial and binary logistic modelling approaches (validated in development dataset, secondary analysis)
sim.out.calib.data.multinomial.devel <- vector("list", N.sim)
sim.out.calib.data.multinomial.rcs3.devel <- vector("list", N.sim)
sim.out.calib.data.multinomial.rcs4.devel <- vector("list", N.sim)
sim.out.calib.data.multinomial.rcs5.devel <- vector("list", N.sim)
sim.out.calib.data.binary.devel <- vector("list", N.sim)
sim.out.calib.data.binary.rcs3.devel <- vector("list", N.sim)
sim.out.calib.data.binary.rcs4.devel <- vector("list", N.sim)
sim.out.calib.data.binary.rcs5.devel <- vector("list", N.sim)

sim.out.shrink.multinomial.devel <- rep(NA, N.sim)
sim.out.shrink.multinomial.rcs3.devel <- rep(NA, N.sim)
sim.out.shrink.multinomial.rcs4.devel <- rep(NA, N.sim)
sim.out.shrink.multinomial.rcs5.devel <- rep(NA, N.sim)
sim.out.shrink.binary.devel <- rep(NA, N.sim)
sim.out.shrink.binary.rcs3.devel <- rep(NA, N.sim)
sim.out.shrink.binary.rcs4.devel <- rep(NA, N.sim)
sim.out.shrink.binary.rcs5.devel <- rep(NA, N.sim)

sim.out.Cstat.multinomial.devel <- rep(NA, N.sim)
sim.out.Cstat.multinomial.rcs3.devel <- rep(NA, N.sim)
sim.out.Cstat.multinomial.rcs4.devel <- rep(NA, N.sim)
sim.out.Cstat.multinomial.rcs5.devel <- rep(NA, N.sim)
sim.out.Cstat.binary.devel <- rep(NA, N.sim)
sim.out.Cstat.binary.rcs3.devel <- rep(NA, N.sim)
sim.out.Cstat.binary.rcs4.devel <- rep(NA, N.sim)
sim.out.Cstat.binary.rcs5.devel <- rep(NA, N.sim)
...
for (i in 1:N.sim){
  ...
  ### Also run the calibration in the development dataset
  sim.out.multinomial.devel <- calibrate.model.multinomial.predfix(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval)
  sim.out.multinomial.rcs3.devel <- calibrate.model.multinomial.predfix.rcs(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval, 
                                                                  n.knot.in = 3)
  sim.out.multinomial.rcs4.devel <- calibrate.model.multinomial.predfix.rcs(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval, 
                                                                  n.knot.in = 4)
  sim.out.multinomial.rcs5.devel <- calibrate.model.multinomial.predfix.rcs(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval, 
                                                                  n.knot.in = 5)
  sim.out.binary.devel <- calibrate.model.binary.predfix(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval)
  sim.out.binary.rcs3.devel <- calibrate.model.binary.predfix.rcs(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval, 
                                                            n.knot.in = 3)
  sim.out.binary.rcs4.devel <- calibrate.model.binary.predfix.rcs(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval, 
                                                            n.knot.in = 4)
  sim.out.binary.rcs5.devel <- calibrate.model.binary.predfix.rcs(dat.devel = data.devel, dat.valid = data.devel, pred.eval = pred.eval, 
                                                            n.knot.in = 5)
  ...
  ### Put respective simulation output into the correct objects (validated in development dataset)
  ## Calibration plot data
  sim.out.calib.data.multinomial.devel[[i]] <- sim.out.multinomial.devel[[1]]
  sim.out.calib.data.multinomial.rcs3.devel[[i]] <- sim.out.multinomial.rcs3.devel[[1]]
  sim.out.calib.data.multinomial.rcs4.devel[[i]] <- sim.out.multinomial.rcs4.devel[[1]]
  sim.out.calib.data.multinomial.rcs5.devel[[i]] <- sim.out.multinomial.rcs5.devel[[1]]
  sim.out.calib.data.binary.devel[[i]] <- sim.out.binary.devel[[1]]
  sim.out.calib.data.binary.rcs3.devel[[i]] <- sim.out.binary.rcs3.devel[[1]]
  sim.out.calib.data.binary.rcs4.devel[[i]] <- sim.out.binary.rcs4.devel[[1]]
  sim.out.calib.data.binary.rcs5.devel[[i]] <- sim.out.binary.rcs5.devel[[1]]
  
  ## Shrinkage factor/calibration slope
  ## Cstatistics
  sim.out.shrink.multinomial.devel[i] <- sim.out.multinomial.devel[[2]]
  sim.out.shrink.multinomial.rcs3.devel[i] <- sim.out.multinomial.rcs3.devel[[2]]
  sim.out.shrink.multinomial.rcs4.devel[i] <- sim.out.multinomial.rcs4.devel[[2]]
  sim.out.shrink.multinomial.rcs5.devel[i] <- sim.out.multinomial.rcs5.devel[[2]]
  sim.out.shrink.binary.devel[i] <- sim.out.binary.devel[[2]]
  sim.out.shrink.binary.rcs3.devel[i] <- sim.out.binary.rcs3.devel[[2]]
  sim.out.shrink.binary.rcs4.devel[i] <- sim.out.binary.rcs4.devel[[2]]
  sim.out.shrink.binary.rcs5.devel[i] <- sim.out.binary.rcs5.devel[[2]]
  
  ## Cstatistics
  sim.out.Cstat.multinomial.devel[i] <- sim.out.multinomial.devel[[3]]
  sim.out.Cstat.multinomial.rcs3.devel[i] <- sim.out.multinomial.rcs3.devel[[3]]
  sim.out.Cstat.multinomial.rcs4.devel[i] <- sim.out.multinomial.rcs4.devel[[3]]
  sim.out.Cstat.multinomial.rcs5.devel[i] <- sim.out.multinomial.rcs5.devel[[3]]
  sim.out.Cstat.binary.devel[i] <- sim.out.binary.devel[[3]]
  sim.out.Cstat.binary.rcs3.devel[i] <- sim.out.binary.rcs3.devel[[3]]
  sim.out.Cstat.binary.rcs4.devel[i] <- sim.out.binary.rcs4.devel[[3]]
  sim.out.Cstat.binary.rcs5.devel[i] <- sim.out.binary.rcs5.devel[[3]]
  
  ## Add a variable indicating the simulation run to the calibration plot data
  sim.out.calib.data.multinomial.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.multinomial.devel[[i]]))
  sim.out.calib.data.multinomial.rcs3.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.multinomial.rcs3.devel[[i]]))
  sim.out.calib.data.multinomial.rcs4.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.multinomial.rcs4.devel[[i]]))
  sim.out.calib.data.multinomial.rcs5.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.multinomial.rcs5.devel[[i]]))
  sim.out.calib.data.binary.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.binary.devel[[i]]))
  sim.out.calib.data.binary.rcs3.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.binary.rcs3.devel[[i]]))
  sim.out.calib.data.binary.rcs4.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.binary.rcs4.devel[[i]]))
  sim.out.calib.data.binary.rcs5.devel[[i]]$sim.run <- rep(i, nrow(sim.out.calib.data.binary.rcs5.devel[[i]]))
...
save.image(paste("data/s", scenario.sim, "/sim_run_DGMmult_scen" , scenario.sim, ".", seed.coef.sim, "_K", 
